        ...
        <div className="relative z-10 flex flex-col justify-center items-start p-12 text-white">
          <div className="mb-8">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <span className="text-3xl font-bold">TasteHaven</span>
            </div>
            <h1 className="text-4xl font-bold mb-4">Join Our Family</h1>
            <p className="text-xl text-white/90 leading-relaxed">
              Create your account and unlock a world of culinary excellence. Experience premium dining and exceptional hospitality.
            </p>
          </div>
          <div className="space-y-4 text-white/80">
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-white rounded-full"></div>
              <span>Exclusive member-only events and tastings</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-white rounded-full"></div>
            ...
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-white rounded-full"></div>
              <span>Loyalty rewards and birthday surprises</span>
            </div>
          </div>
        </div>
      </div>
